...
#fi
  ...
  # Line 1
  echo -n $turquoise'╭─'$hotpink$current_user$white' at '$orange$__fish_prompt_hostname$white' in '$limegreen(pwd|sed "s=$HOME=⌁=")$turquoise
  __fish_git_prompt " (%s)"
  echo
  ...
  echo -n $turquoise'─'$__fish_prompt_char $normal
end
...
alias upd='sudo reflector --latest 5 --country India --age 2 --fastest 5 --protocol https --sort rate --save /etc/pacman.d/mirrorlist && cat /etc/pacman.d/mirrorlist && sudo pacman -Syu'
