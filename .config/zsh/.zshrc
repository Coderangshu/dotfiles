...
alias upd='sudo -S sudo powerpill -Su && paru -Su'
alias ..='cd ..'
alias ...='cd ../..'
alias ....='cd ../../..'
alias .....='cd ../../../..'
...
alias big="expac -H M '%m\t%n' | sort -hr| nl | less"              # Sort installed packages according to size in MB (expac must be installed)
