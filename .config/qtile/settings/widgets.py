...
primary_widgets = [
    ...
    *workspaces(),
    ...
    colour_have_updates=colors['color4'],colour_no_updates=colors['color4'],no_update_string='No updates', execute="echo -e '123' | sudo -S sudo powerpill --noconfirm -Su && paru --noconfirm -Su && notify-send 'System Updated'"),
    ...
    widget.WidgetBox(**base(fg='color3'), 
                    ...
                    widget.ThermalSensor(**base(fg='color3'),fmt="@ {}"),
    ...
    # Network Speed
    widget.WidgetBox(**base(fg='color5'), widgets=[widget.Net(**base(fg='color5'), format='{up}↑')],text_closed='',text_open=' ',fontsize=20),
    ...
    widget.WidgetBox(**base(fg='color6'), widgets=[widget.Clock(**base(fg='color6'), 
                                                   format=' %A ')], text_closed='',text_open='', fontsize=22),
